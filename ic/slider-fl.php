...
<div class="slide-box-inner">
    <div class="slide-box" id="slide-box">
        <ul id="inner-slide-box">
            <li><a href="" target="_blank"><img src="<?php $this->options->themeUrl('ic/slider/a.jpg'); ?>"></a></li>
            <li><a href="" target="_blank"><img src="<?php $this->options->themeUrl('ic/slider/b.jpg'); ?>"></a></li>
            <li><a href="" target="_blank"><img src="<?php $this->options->themeUrl('ic/slider/c.jpg'); ?>"></a></li>
            <li><a href="" target="_blank"><img src="<?php $this->options->themeUrl('ic/slider/d.jpg'); ?>"></a></li>
            <li><a href="" target="_blank"><img src="<?php $this->options->themeUrl('ic/slider/a.jpg'); ?>"></a></li>
        </ul>
        <ol id="slide-ol">
            <li></li>
